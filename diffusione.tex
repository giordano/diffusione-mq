...
\item il processo di diffusione non è in generale isotropico, quindi l'ampiezza
  dell'onda di diffusione sarà modulata da un fattore del tipo
  $f_{k}(\theta,\phi)$, dipendente dall'energia mediante il numero d'onda $k$ e
  dalle due coordinate angolari sferiche $\theta$ e
...
particolare, se risulta $kL \gg 1$ queste oscillazioni diventano molto frequenti
all'interno del raggio d'azione del potenziale e abbiamo
