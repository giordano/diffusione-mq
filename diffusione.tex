...
Born è applicabile se il potenziale è sufficientemente debole, in questo caso le
deflessioni $\delta_{l}$ prodotte dal potenziale di interazione sferico saranno
...
Ciò è dovuto al fatto che il potenziale coulombiano non è a corto raggio.  È
...
% TODO (non importante): nota che per la definizione del risolvete ho seguito la
% convenzione del Ballentine: G = (z - H_0)^{-1}, mentre Martina e Boiti
% utilizzano la convenzione G = (H_0 - z)^{-1} e la matrice di trasferimento
% (vedi appunti del 27/01/2012) è scritta come G = G - G_0 T G_0.  Se mi decido,
% un giorno converto tutto nella convenzione di Martina.
