...
d'azione del potenziale.  Non è semplice individuare una condizione precisa
sotto la quale sia possibile applicare l'approssimazione di Born, tuttavia si
intuisce che questa diventa più affidabile per grandi valori dell'energia della
particella
...
% web.ihep.su/dbserv/compas/src/yukawa35/eng.pdf
...
$1/\theta^{4}$ per piccoli angoli.  Nella figura~\ref{fig:sez-urto-yukawa} è
rappresentata la distribuzione angolare della sezione d'urto differenziale.  La
sezione d'urto totale del potenziale di Yukawa è
\begin{equation}
