...
alcuna dipendenza dall'angolo azimutale $\phi$.  Pertanto per annullare la
dipendenza della funzione d'onda $\psi(\bm{r})$ da $\phi$ nello
sviluppo~\eqref{eq:onde-parziali1} dobbiamo considerare solo i termini con
