...
equivale a dire che l'approssimazione di Born vale quando il potenziale (se
attrattivo) è sufficientemente debole da non creare uno stato legato per la
particella relativa.
...
valore massimo $V_{0}$ e raggio $L$, se risulta $kL \gg 1$ queste oscillazioni
